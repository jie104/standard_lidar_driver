...
if("TRUE" STREQUAL "TRUE")
  set(urg_c_SOURCE_PREFIX /home/zxj/workspace/obstacle_and_filter/standard_lidar4_ws/src/urg_c-master)
  set(urg_c_DEVEL_PREFIX /home/zxj/workspace/obstacle_and_filter/standard_lidar4_ws/devel)
  set(urg_c_INSTALL_PREFIX "")
  set(urg_c_PREFIX ${urg_c_DEVEL_PREFIX})
else()
  set(urg_c_SOURCE_PREFIX "")
  set(urg_c_DEVEL_PREFIX "")
  set(urg_c_INSTALL_PREFIX /home/zxj/workspace/obstacle_and_filter/standard_lidar4_ws/install)
...
if(NOT "/home/zxj/workspace/obstacle_and_filter/standard_lidar4_ws/src/urg_c-master/current/include " STREQUAL " ")
  set(urg_c_INCLUDE_DIRS "")
  set(_include_dirs "/home/zxj/workspace/obstacle_and_filter/standard_lidar4_ws/src/urg_c-master/current/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'urg_c' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/zxj/workspace/obstacle_and_filter/standard_lidar4_ws/src/urg_c-master/${idir}'.  ${_report}")
    endif()
