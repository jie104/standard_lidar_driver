...
int main(int argc, char **argv) {
    ...
    ros::init(argc, argv, "ORADAR_2",ros::init_options::AnonymousName);

    ros::NodeHandle nh("~");
    std::string ip;
    int port;
    nh.param<std::string>("ip",ip,"192.168.71.103");
    ...
    ros::Publisher scan_pub = nh.advertise<sensor_msgs::LaserScan>("/oradar_node_2/scan", 1000);
