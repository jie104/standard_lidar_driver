...
//
#ifndef SROS_LEIMOU1_LASER_PROTOCOL_HPP
#define SROS_LEIMOU1_LASER_PROTOCOL_HPP
...
namespace sros {
    class LeimouLaserProtocol1 : public LaserProtocolInterface {
    public:
        ...
        virtual bool resolvePackage(boost::circular_buffer<char> &ring_buffer, int start_index) {
            ...
            if (package_datas_[5]==0x03) {
                ...
                package_datas_.resize(data_length-18); // 4330
