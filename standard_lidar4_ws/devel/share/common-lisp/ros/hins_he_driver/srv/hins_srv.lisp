...
(cl:in-package hins_he_driver-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <hins_srv-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'hins_srv-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name hins_he_driver-srv:<hins_srv-request> is deprecated: use hins_he_driver-srv:hins_srv-request instead.")))

(cl:ensure-generic-function 'channel-val :lambda-list '(m))
(cl:defmethod channel-val ((m <hins_srv-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hins_he_driver-srv:channel-val is deprecated.  Use hins_he_driver-srv:channel instead.")
  (channel m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<hins_srv-request>)))
  ...
  "hins_he_driver/hins_srvRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'hins_srv-request)))
  "Returns string type for a service object of type 'hins_srv-request"
  "hins_he_driver/hins_srvRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <hins_srv-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'hins_srv-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name hins_he_driver-srv:<hins_srv-response> is deprecated: use hins_he_driver-srv:hins_srv-response instead.")))

(cl:ensure-generic-function 'area1-val :lambda-list '(m))
(cl:defmethod area1-val ((m <hins_srv-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hins_he_driver-srv:area1-val is deprecated.  Use hins_he_driver-srv:area1 instead.")
  (area1 m))

(cl:ensure-generic-function 'area2-val :lambda-list '(m))
(cl:defmethod area2-val ((m <hins_srv-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hins_he_driver-srv:area2-val is deprecated.  Use hins_he_driver-srv:area2 instead.")
  (area2 m))

(cl:ensure-generic-function 'area3-val :lambda-list '(m))
(cl:defmethod area3-val ((m <hins_srv-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hins_he_driver-srv:area3-val is deprecated.  Use hins_he_driver-srv:area3 instead.")
  (area3 m))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <hins_srv-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hins_he_driver-srv:success-val is deprecated.  Use hins_he_driver-srv:success instead.")
  (success m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<hins_srv-response>)))
  ...
  "hins_he_driver/hins_srvResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'hins_srv-response)))
  "Returns string type for a service object of type 'hins_srv-response"
  "hins_he_driver/hins_srvResponse")
